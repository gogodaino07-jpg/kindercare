...
3. 필드 작성:
   ...
   - note: 반드시 챙겨야 할 '물건' 이름만 담으세요. 쇼핑 검색이 용이하도록 "금액"이나 "포장 조건" 등은 제외하고 핵심 물건 명칭만 적으세요. 여러 물건은 줄바꿈(\\n)으로 구분하세요. (예: "물통\\n도시락\\n운동화")
   - memo: 금액, 장소, 시간, 복장, 혹은 "3,000원 이내", "개별 포장" 같은 구체적인 조건을 요약하세요. (쇼핑 검색에 불필요한 모든 부가 정보는 여기에 넣으세요)
   - icon: 성격에 맞는 이모지 1개
