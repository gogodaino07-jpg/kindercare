...
function createStyles(colors: any) {
  return StyleSheet.create({
    ...
    avatarInitial: { fontSize: 15, fontWeight: '800', color: colors.accent },
    profileNameRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 1 },
    profileName: { fontSize: 14.5, fontWeight: '800', color: colors.textPrimary, flexShrink: 1 },
    proBadge: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 2,
    ...
    versionContainer: { alignItems: 'center', marginTop: 14 },
    versionText: { fontSize: 12, color: colors.textSecondary, fontWeight: '600' },
    footerLinkRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 20 },
    ...
    legalLinkRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingBottom: 26, flexWrap: 'wrap' },
