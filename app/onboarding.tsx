...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 26, marginBottom: 22, fontSize: 27, fontWeight: '800', color: COLORS.ink, textAlign: 'center', lineHeight: 35 },
  subtitle: { marginBottom: 20, fontSize: 17, color: COLORS.gray, textAlign: 'center', lineHeight: 25, fontWeight: '600' },
